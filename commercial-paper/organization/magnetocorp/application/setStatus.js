...
async function main() {
    ...
    try {
        ...
        const issueResponse = await contract.submitTransaction('updateUBLStatus', process.argv.slice(2,3).toString(), process.argv.slice(3,4).toString(), process.argv.slice(4,5).toString());
        // process response
